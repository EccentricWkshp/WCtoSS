...
class ShipStationOrder(ShipStationBase):
    ...
    def __init__(self, order_key=None, order_number=None):
        ...
        self.order_date = None #datetime.datetime.now().isoformat()
        ...
        self.payment_date = None #datetime.datetime.now().isoformat()
    ...
    def set_confirmation(self, confirmation=None):
        if not confirmation:
            ...
            self.order_confirmation = confirmation
    ...
    def set_payment_date(self, date): ####### added this in #######
